...
export type WorkshopStackParamList = {
  ...
  QualityControlDashboard: undefined;
  QualityCheckList: undefined;
  QualityCheckDetail: { id: string };
  QualityCheckForm: { id?: string; qualityCheck?: any };
  QualityInspectionList: undefined;
  QualityInspectionDetail: { id: string };
  QualityInspectionForm: { id?: string; inspection?: any };
  QualityDefectList: undefined;
  QualityDefectDetail: { id: string };
  QualityDefectForm: { id?: string; defect?: any };
  QualityReportList: undefined;
  QualityReportDetail: { id: string };
  QualityReportForm: { id?: string; report?: any };
