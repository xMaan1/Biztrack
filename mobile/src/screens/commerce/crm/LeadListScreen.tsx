...
import { Lead, LeadStatus, LeadSource, CRMLeadFilters } from '@/models/crm';
...
export default function LeadListScreen() {
  ...
  const loadLeads = async () => {
    try {
      setLoading(true);
      const response = await CRMService.getLeads(filters, currentPage, itemsPerPage);
            ...
            <View style={styles.filterOptions}>
              {Object.values(LeadSource).map((source) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterChip,
                    filters.source === source && styles.filterChipActive,
                  ]}
                  onPress={() =>
                    setFilters((prev) => ({
                      ...prev,
                ...
                >
                  <Text
                    style={[
                      styles.filterChipText,
                      filters.source === source && styles.filterChipTextActive,
                    ]}
                  >
                    {source}
                  </Text>
