...
export const SIDEBAR_PATH_PERMISSIONS: Record<string, string> = {
  ...
  '/workshop-management/mot-bookings': 'production:view',
  '/workshop-management/mot-bookings/new': 'production:view',
  '/workshop-management/mot-bookings/*/confirmation': 'production:view',
