...
from ...presentation.dependencies.auth import get_current_user, require_tenant_admin_or_super_admin
...
async def get_usage_summary(
    ...
    try:
        ...
        from ...presentation.dependencies.auth import get_tenant_context
...
async def upgrade_plan(
    ...
    try:
        ...
        from ...presentation.dependencies.auth import get_tenant_context, require_tenant_admin_or_super_admin
